...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/AEPS3//css/perfil.css">
</head>
<body>
    <div class="profile-container">
        ...
        <div class="profile-info">
            ...
            <p><strong>Senha:<?php echo$_SESSION["password"];?></strong></p>
        ...
        <button class="btn btn-light profile-option">Favoritos</button>
